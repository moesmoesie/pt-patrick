...
const Card: React.FC<CardProps> = (props) => {
  return (
    <div className="shadow-1 rounded-[20px] border border-amethyst bg-white px-4 py-3 supports-backdrop-filter:bg-white/40 supports-backdrop-filter:backdrop-blur-md large:px-5 large:py-6">
